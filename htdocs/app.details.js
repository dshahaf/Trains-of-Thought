...
(function(ns){
    ...
    var details = function() {
        ...
        var _templateOrg = '<div id="details" style="display:none">\
		    <div class="controls">\
        ...
        var _template = '<div id="details" style="position:relative; left:0; top:0; width:10%; border-style:solid"">\
		    <div class="row field-label">\
		        <label>Label:</label> <span>&#160;</span>\
		    </div>\
		    <div class="row field-label">\
		...
		_template = '<div id="details" style="background: white; border-color: gray; border-width:thin;  left:75%; top:0; max-width:25%; min-width:25%; width:25%; border-style:solid""><table>';
		for (var i=0; i<window._lines.Keys.length; i++)
		{
			Line = window._lines.Lookup(window._lines.Keys[i]);
			_template+="<tr><td><span style='margin:3px;float:left;width:20px;height:3px;background-color:" + Line.color + "'></span></td><td>" + Line.name + "</td></tr>";
		}

		_template+= '</table></div>';


            $('.map1').append(_template);

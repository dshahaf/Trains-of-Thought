...
(function(ns){
    ...
    var springlayout = function() {
        ...
        ------------------------------------------------------- */
        var _iterations = 500;
        var _maxRepulsiveForceDistance = 6;
        var _k = 2;
        var _c = 0.01;
        var _maxVertexMovement = 0.5;
        ...
        var prepareNodesPreCompute = function(nodes, edges) {
            var len = nodes.length;
            for (var x = 0; x < len; x++) {
                var node = nodes[x];
                
                node.__x = parseFloat(node.ourx);
                node.__y = parseFloat(node.oury);
                node.__forceX = 0;
                node.__forceY = 0;
            }
        };
        ...
        that.calculate = function(nodes, edges, iterations) {
	     ...
	     prepareNodesPreCompute(nodes, edges);
